...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 shadow-md">
      ...
      <div className="bg-red-50/90 py-2 px-4 text-xs text-slate-700 font-sans hidden md:block border-b border-red-100">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-6">
            <a href="tel:+919876543210" className="hover:text-red-500 flex items-center gap-1.5 transition-colors font-medium">
              <Phone className="w-3.5 h-3.5 text-red-400" />
              <span>+91 98765 43210</span>
            </a>
            <span className="text-red-200">|</span>
            <a href="mailto:support@rented.in" className="hover:text-red-500 flex items-center gap-1.5 transition-colors font-medium">
          ...
          <div className="flex items-center space-x-6">
            <span className="flex items-center gap-1.5 text-red-600 font-medium bg-red-100/70 border border-red-200/60 px-2.5 py-0.5 rounded-md">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-red-300 to-red-400 p-0.5 shadow-md flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
              ...
              <div>
                ...
                <span className="text-[10px] tracking-widest text-red-400 uppercase font-sans font-bold block mt-1">
                  PG • House • Flat • Shop
                </span>
              </div>
            </Link>
            ...
            <nav className="hidden lg:flex items-center space-x-8 font-heading text-sm font-bold tracking-wide">
              ...
              <Link href="/properties" className="text-slate-800 hover:text-red-400 transition-colors flex items-center gap-1">
                <span>All Rentals</span>
              </Link>

              <Link href="/properties?property_type=PG" className="text-slate-800 hover:text-red-400 transition-colors">
                PG / Hostels
              </Link>

              <Link href="/properties?property_type=Flat" className="text-slate-800 hover:text-red-400 transition-colors">
                Flats
              </Link>

              <Link href="/properties?property_type=House" className="text-slate-800 hover:text-red-400 transition-colors">
                Houses
              </Link>

              <Link href="/properties?property_type=Shop" className="text-slate-800 hover:text-red-400 transition-colors">
                Shops
              </Link>

              <Link href="/favorites" className="text-slate-800 hover:text-red-400 transition-colors flex items-center gap-1.5">
