    ...
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans pb-20">
      ...
      <div className="bg-white border-b border-slate-200 py-10 px-4 shadow-sm">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-50 border border-red-200 text-xs font-bold text-red-400 uppercase tracking-widest mb-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-6">
          ...
          <Card3D intensity={6} depth={12}>
            <div className="bg-red-50 p-6 rounded-2xl border border-red-200 shadow-sm">
              ...
              <span className="text-xs text-red-600 font-bold block uppercase tracking-wider">Verified Landlord</span>
              <span className="font-heading text-3xl font-extrabold text-red-600">Active</span>
            </div>
          </Card3D>
        </div>
                ...
                <tbody className="divide-y divide-slate-100 text-slate-800 font-medium">
                  {leads.map((l) => (
                    <tr key={l.id} className="hover:bg-slate-50">
                      ...
                      <td className="py-3 text-red-400 font-bold">{l.property_title || "Rental"}</td>
