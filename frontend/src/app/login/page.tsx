              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-3 text-slate-900 focus:outline-none focus:border-red-400"
                    />
                  </div>
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-[10px] text-red-400 font-bold">For Nearby Rentals</span>
                  </div>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-3 text-slate-900 focus:outline-none focus:border-red-400 font-mono font-bold"
                  />
